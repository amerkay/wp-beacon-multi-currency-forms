...
class Donate_Box_Module extends Abstract_WBCD_Divi_Module
{
    ...
    function init()
    {
        $this->name = esc_html__('Beacon Donation Box', 'wp-beacon-multi-currency-forms');
    }
    ...
    public function get_fields()
    {
        return array_merge(
            [
                ...
                'custom_params' => $this->get_custom_params_field(__('Enter custom parameters in URL format: bcn_c_adopted_animal=12345&key2=value2. This will be added to the URL of the full page form on redirect.', 'wp-beacon-multi-currency-forms')),
            ],
    ...
    public function render($attrs = [], $content = null, $render_slug = '')
    {
        ...
        $render_args = [
            ...
            'title' => isset($this->props['title']) ? $this->props['title'] : __('Make a donation', 'wp-beacon-multi-currency-forms'),
            'subtitle' => isset($this->props['subtitle']) ? $this->props['subtitle'] : __('Pick your currency, frequency, and amount', 'wp-beacon-multi-currency-forms'),
            'noticeText' => isset($this->props['notice_text']) ? $this->props['notice_text'] : __("You'll be taken to our secure donation form to complete your gift.", 'wp-beacon-multi-currency-forms'),
            'buttonText' => isset($this->props['button_text']) ? $this->props['button_text'] : __('Donate now →', 'wp-beacon-multi-currency-forms'),
