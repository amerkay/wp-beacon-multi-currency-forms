...
class Shortcode_Donate_Box
{
    ...
    {
        add_shortcode('beacon_donate_box', [__CLASS__, 'handle']);
    }
    ...
    public static function handle($atts = [])
    {
        ...
        $render_args = [
            'primaryColor' => sanitize_hex_color($atts['primary_color']),
            'brandColor' => sanitize_hex_color($atts['brand_color']),
            'title' => sanitize_text_field($atts['title']),
            'subtitle' => sanitize_text_field($atts['subtitle']),
            'noticeText' => sanitize_textarea_field($atts['notice']),
