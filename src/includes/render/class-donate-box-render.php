        ...
        <div id="wpbcd-donate" class="wpbcd-wrap" style="<?php echo esc_attr($inline_style); ?>"
            ...
            <div class="wpbcd-card">
                ...
                <div class="wpbcd-section">
                    <div class="wpbcd-tabs wpbcd-tabs--row" role="tablist"
                        aria-label="<?php esc_attr_e('Donation frequency', 'wp-beacon-crm-donate'); ?>">
                        <button class="wpbcd-tab wpbcd-btn-frequency" data-frequency="single" type="button"
                            aria-selected="false"><?php esc_html_e('Single', 'wp-beacon-crm-donate'); ?></button>
                        <button class="wpbcd-tab wpbcd-btn-frequency" data-frequency="monthly" type="button"
                            aria-selected="true"><?php esc_html_e('Monthly', 'wp-beacon-crm-donate'); ?></button>
                        <button class="wpbcd-tab wpbcd-btn-frequency" data-frequency="annual" type="button"
                            aria-selected="false"><?php esc_html_e('Annual', 'wp-beacon-crm-donate'); ?></button>
                    </div>
                </div>
                ...
                <div class="wpbcd-amount">
                    <div class="wpbcd-amount-header">
                        ...
                        <label class="wpbcd-currency-select-label" for="wpbcd-currency-select"
                            aria-label="<?php esc_attr_e('Currency', 'wp-beacon-crm-donate'); ?>"></label>
                        <select id="wpbcd-currency-select" class="wpbcd-select"
                    ...
                    <div class="wpbcd-tabs wpbcd-tabs--grid" id="wpbcd-amount-buttons" role="group"
                        aria-label="<?php esc_attr_e('Preset amounts', 'wp-beacon-crm-donate'); ?>">
                        <!-- JS fills preset buttons -->
                    </div>

                    <div class="wpbcd-amount-custom">
                        <button id="wpbcd-toggle-custom" class="wpbcd-link" type="button" aria-expanded="false"
                            aria-controls="wpbcd-custom-wrap"><?php esc_html_e('Custom amount', 'wp-beacon-crm-donate'); ?></button>
                        <div id="wpbcd-custom-wrap" class="wpbcd-input-wrap" hidden>
                            ...
                            ?></span>
                            <input id="wpbcd-custom-amount" type="number" min="1" step="1" inputmode="decimal"
                                placeholder="0" />
                        </div>
                    </div>
                </div>
                ...
                <div class="wpbcd-actions">
                    <button id="wpbcd-next" class="wpbcd-button wpbcd-button--md" type="button"
                        aria-label="<?php esc_attr_e('Continue to secure form', 'wp-beacon-crm-donate'); ?>"
