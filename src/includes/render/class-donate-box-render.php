...
class Donate_Box_Render
{
    ...
    public static function render($form_name = '', $args = [])
    {
        ...
        if (empty($currencies)) {
            ...
            return '<div class="wpbmcf-wrap"><p>' . esc_html__('Please configure donation forms in the Beacon Multi-Currency Forms settings.', 'beacon-multi-currency-forms') . '</p></div>';
        }
                    ...
                    <div class="wpbmcf-card">
                        ...
                        <div class="wpbmcf-amount">
                            <div class="wpbmcf-amount-header">
                                <div class="wpbmcf-amount-label"><?php esc_html_e('Amount', 'beacon-multi-currency-forms'); ?></div>
                            ...
                            <div class="wpbmcf-amount-custom">
                                <button id="wpbmcf-toggle-custom" class="wpbmcf-link" type="button" aria-expanded="false"
                                    aria-controls="wpbmcf-custom-wrap"><?php esc_html_e('Custom amount', 'beacon-multi-currency-forms'); ?></button>
