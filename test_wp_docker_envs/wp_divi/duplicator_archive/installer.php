...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'wp_divi_test_82ba1e535e39362f7814_20251102041458_archive.zip';
        const ARCHIVE_SIZE       = '85930826';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '82ba1e5-02041458';
        const SECONDARY_PACKAGE_HASH = '596011b-02041458';
